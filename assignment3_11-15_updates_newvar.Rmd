...
```{r}
full_model <- lm(pct_change ~ avg_1819 + pct_AMI + AH + pct_owner, data)

summary(full_model)

```
This multivariate regression confirms what we saw in the bivariate regressions: the only variable that has a significant relationship with percent change in property value is the presence of affordable housing. ********
